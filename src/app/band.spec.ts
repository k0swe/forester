...
describe('Band', () => {
  ...
  it('should map amateur frequencies to bands', () => {
    ...
    expect(Band.freqToBand(224.740)).toBe('1.25m');
    expect(Band.freqToBand(449.450)).toBe('70cm');
